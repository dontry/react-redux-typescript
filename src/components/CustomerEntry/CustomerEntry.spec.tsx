...
describe("CustomerEntry", () => {
    it("should render the component with a customer name", () => {
        ...
        expect(getByTestId("customer-name")).toHaveTextContent(`${customer.firstName} ${customer.lastName}`)
    })
    ...
    it("calls deleteCustomer function by clicking delete button", () => {
        ...
        const { getByTestId } = render(<CustomerEntry customer={customer} onDelete={actions.deleteCustomer} />)
